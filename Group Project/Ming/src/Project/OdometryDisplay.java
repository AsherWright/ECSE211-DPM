...
public class OdometryDisplay extends Thread {
	...
	/**
	 * Starts the LCD Display thread for the odometer
	 */
	public void run() {
		...
		while (true) {
			...
			//LCD.drawString("US Distance: " + Ucon.readUSDistance(), 0, 4 );
	...
	/**
	 * Takes in a double and returns a string version of it
	 *  
	 * @param x The double to be converted
	 * @param places The number of decimal places to include
	 * @return The first (places) numbers of (x), in string form
	 */
