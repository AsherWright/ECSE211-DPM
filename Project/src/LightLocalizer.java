...
public class LightLocalizer {
	...
	public void doLocalization() {
		...
		leftMotor.rotate(-convertDistance(Controller.WHEEL_RADIUS, DISTANCE_FROM_EDGE), true); //two tiles = 60.96
		rightMotor.rotate(-convertDistance(Controller.WHEEL_RADIUS, DISTANCE_FROM_EDGE), false);
		...
		leftMotor.rotate(-convertAngle(Controller.WHEEL_RADIUS, Controller.TRACK, 90.0), true);
		rightMotor.rotate(convertAngle(Controller.WHEEL_RADIUS, Controller.TRACK, 90.0), false);
